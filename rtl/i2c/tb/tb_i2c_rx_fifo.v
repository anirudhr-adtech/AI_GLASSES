`timescale 1ns / 1ps
//============================================================================
// tb_i2c_rx_fifo.v — Self-checking testbench for i2c_rx_fifo
//============================================================================

module tb_i2c_rx_fifo;
    ...
    initial begin
        ...
        $display("========================================");
        if (fail_count == 0)
            $display("I2C RX FIFO TB: ALL %0d TESTS PASSED", pass_count);
        else
            $display("I2C RX FIFO TB: %0d PASSED, %0d FAILED", pass_count, fail_count);
        $display("========================================");
        $finish;
    end
